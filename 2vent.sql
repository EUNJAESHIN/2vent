...
(2, '테스트2', 0, 0, 'EditText는 \"텍스트 입력\"이라는, 어찌보면 매우 단순한 기능을 갖고 있지만, TextView로부터 상속받은 다양한 속성을 통해 여러 가지 유용한 기능들을 제공합니다. 텍스트 입력을 위한 소프트 키보드를 바꾸거나, 숫자만 입력 가능하도록 만드는 것과 같은 기능이 대표적이죠.', 5000, 4000, 96, '2017-07-30', '2017-08-11', '20:00:00', '20:00:00', 0, 0, 0, 0, 0, '', '22222222222', '1'),
...
(32, '테스트11', 0, 0, 'event_img/1/event_32.jpg', 20000, 18000, 93, '2017-08-03', '2017-08-10', '20:00:00', '20:00:00', 0, 0, 0, 0, 0, '', '11111111111', '1');
