    ...
    private class LeavingTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("탈퇴 처리 완료")) {
                ...
                finish();
                Activity_User_Login.toast = Toast.makeText(Activity_User_Info.this, "탈퇴 되었습니다", Toast.LENGTH_SHORT);
                Activity_User_Login.toast.show();
            } else {
                Activity_User_Login.toast = Toast.makeText(Activity_User_Info.this, "Withdrawal Error", Toast.LENGTH_SHORT);
                Activity_User_Login.toast.show();
            }
